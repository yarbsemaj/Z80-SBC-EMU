...
An emulator for my Z80 Based Single board computer, based on [Grant Searle's design](http://searle.x10host.com/z80/SimpleZ80.html). As the RC2014 is also based on Grant's design, it is also compatible.
